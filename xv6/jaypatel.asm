...
_jaypatel:     file format elf32-i386
...
main(void) {
   ...
   e:	83 ec 0c             	sub    $0xc,%esp
	printf(1," Hello World! My Name is Jay Patel and My CWID is A20328510\n");
 ...
 339:	85 d2                	test   %edx,%edx
{
 ...
 367:	f7 f1                	div    %ecx
 369:	0f b6 92 70 07 00 00 	movzbl 0x770(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 584:	e9 8f fe ff ff       	jmp    418 <printf+0x48>
          s = "(null)";
 589:	bb 68 07 00 00       	mov    $0x768,%ebx
        while(*s != 0){
 ...
 5a1:	a1 14 0a 00 00       	mov    0xa14,%eax
{
 ...
 5dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5df:	a3 14 0a 00 00       	mov    %eax,0xa14
}
 5e4:	5b                   	pop    %ebx
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 67f:	73 47                	jae    6c8 <malloc+0x98>
    ...
    if(p == freep)
 681:	39 05 14 0a 00 00    	cmp    %eax,0xa14
 ...
 6a6:	e8 f5 fe ff ff       	call   5a0 <free>
  return freep;
 6ab:	8b 15 14 0a 00 00    	mov    0xa14,%edx
 ...
 6d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6d7:	89 15 14 0a 00 00    	mov    %edx,0xa14
}
 ...
 6e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 14 0a 00 00 18 	movl   $0xa18,0xa14
 6f7:	0a 00 00 
 6fa:	c7 05 18 0a 00 00 18 	movl   $0xa18,0xa18
 701:	0a 00 00 
    base.s.size = 0;
 704:	b8 18 0a 00 00       	mov    $0xa18,%eax
 709:	c7 05 1c 0a 00 00 00 	movl   $0x0,0xa1c
 710:	00 00 00 
